/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: 6ee9ac7ec1ade86737dd246ad4e0fcdb)
// Runtime types generated with workerd@1.20250803.0 2025-04-12 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		AUTO_PODCAST_GENERATOR_KV: KVNamespace;
		NEXTJS_ENV: string;
		...
		AUTO_PODCAST_GENERATOR_R2: R2Bucket;
		NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
		WORKER_SELF_REFERENCE: Fetcher /* auto-podcast-generator-worker */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXTJS_ENV" | "NEXT_PUBLIC_BASE_URL" | "NEXT_STATIC_HOST">> {}
}
